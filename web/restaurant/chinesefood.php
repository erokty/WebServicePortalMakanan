<?php 
	...
	if($con) 
	{
                ...
                $sql= "SELECT * FROM tbl_groupingrestaurant JOIN tbl_grouping ON tbl_groupingrestaurant.grouping_id = tbl_grouping.grouping_id JOIN tbl_restaurant ON tbl_groupingrestaurant.restaurant_id = tbl_restaurant.restaurant_id WHERE tbl_grouping.grouping_id=2"; 
